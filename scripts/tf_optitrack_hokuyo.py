...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        #br_rgbd.sendTransform((0.0, 0.0, 0.18), (0.5, 0.5, 0.5, 0.5), rospy.Time.now(), "rgbd", "")
        #br_rgbd.sendTransform((0.0, 0.0, 0.18), (0.5, 0.5, 0.5, 0.5), rospy.Time.now(), "camera_depth_optical_frame", "ME133_Turtlebot")
        br_rgbd.sendTransform((0.06, 0.0, 0.23), (0, 0.0, 0.7071, 0.7071), rospy.Time.now(), "laser", "ME133_Turtlebot")
        rate.sleep()
