function [A_nom, B_nom, K_nom] = find_nominal_model_ctrl(n, m, f_u, Q, R)
    ...
    A_nom = double(subs(jacobian(f_u(0,x,u),x),[x;u],[0;0;0]));
    B_nom = double(subs(jacobian(f_u(0,x,u),u),[x;u],[0;0;0]));
